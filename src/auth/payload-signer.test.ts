...
import { makeSigner } from "./index.js";
...
describe("PayloadSigner", () => {
  ...
  test("sign", () => {
    ...
    const signer = makeSigner("payload", { secretKey, expirationTime: 0 });
    const signature = signer.signature(timestamp, body);
  ...
  test("sign - special characters", () => {
    ...
    expect(signature).toBe(
      "58033ab867ff3be7eaba373a50ea8a21b716ef5b0cbab8663e48e82ad6694eec17281c132ccde4dbe61ff19e2263513e265a2da90de8748e7c70c818d489cc04"
    );
  });
});
